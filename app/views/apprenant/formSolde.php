 ...
 */
?>
<script> window.document.title = "Wigefor --Solvabilité"</script>

<div class="col-md-12 col-md-offset-0">
    <div class="row register-form col-md-9 col-md-offset-2">
        <div class="form-horizontal custom-form hidden-print" >
            ...
            <div class="form-group col-md-6" >
                ...
                <div class="col-md-7 input-column  ">
                    <select class="form-control" id="formation" name="formation" oninput=" getSolvableApprenantList();" >
    ...
    <div class="col-md-12 col-sm-12 col-xs-12 col-md-offset-2" id="list" style="width:90%;">
    </div>
</div>
