...
<div class="col-md-10 col-md-offset-1">
        ...
        <div class="row register-form col-md-5 col-md-offset-2">
            ...
            <div class="form-group col-md-12" >
                    ...
                    <div class="col-md-7 input-column  ">
                        <select class="form-control" id="formation" name="formation" oninput="getListEvaluation(annee.value);" >
                ...
                <div class="form-group col-md-12" >
                    ...
                    <div class="col-md-7 input-column  ">
                        <select class="form-control" id="examen" name="examen" oninput="getEvalMatiere(formation.value,this.value);" >
                ...
                <div class="form-group col-md-12" >
                    ...
                    <div class="col-md-7 input-column  ">
                        <select class="form-control" id="matiere" name="matiere" oninput="getFormNote(annee.value,examen.value,formation.value,matiere.value);" >
